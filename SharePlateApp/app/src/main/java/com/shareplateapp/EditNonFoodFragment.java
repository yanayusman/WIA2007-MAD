...
public class EditNonFoodFragment extends DonateNonFoodFragment {
    ...
    private NonFoodItem donationItem;

    public static EditNonFoodFragment newInstance(NonFoodItem item) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            donationItem = (NonFoodItem) getArguments().getSerializable(ARG_DONATION_ITEM);
    ...
    protected void submitDonation() {
        ...
        NonFoodItem updatedItem = new NonFoodItem(
    ...
    private void updateDonationInFirestore(NonFoodItem updatedItem) {
